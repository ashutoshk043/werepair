...
<div class="container">
  <h2 style="text-align: center; text-transform: capitalize; margin: 15px;font-weight: 700; font-family: 'Lobster', cursive;">Window ac</h2>
  <div class="row">
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
      <img src="images/window-ac.jpg" alt="split_ac_image" class="img-fluid mt-5">
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <img src="images/window-ac2.jpg" alt="images" style="width:100%; max-height: 400px; padding: 15px;">
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
