...
<style>
  ...
  <a class="navbar-brand pl-3" href="index.php">WEREPAIR.COM</a>
  ...
  <div class="dropdown-menu" style="background-color: #000; color:#fff; " aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" style="background-color: #000; color:#fff; " href="dereezer.php">Deepfreezer</a>
  </div>
</div>
      <li class="nav-item">
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  ...
  <div class="card-body">
    ...
    <section class="companies&towers">
...
<!-- main suggestion starts here -->
<div class="container  main_suggestion">
    <div class="pop_Up">
      <button id="close_button" class="btn btn-danger text-left mt-1">Close</button>
      <h5 class="text-center mt-1">Overview with in <div id="some_div"></div></h5><hr>
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" style="text-align: center; margin: auto;">
          <div style="text-align: justify;">
      
      </div>
          <ul style="text-transform: capitalize; font-size: 17px; font-family: 'Lobster', cursive; text-align: justify; max-height: 100vh;">
            <li>popup for quick understanding</li><hr>
            <li>Pop up for quick contact</li><hr>
            <li>show User's name after login </li><hr>
            <li>Realtime search using Ajax</li><hr>
            <li>Random customer's feedback form database.</li><hr>
          </ul>
        </div>

        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6" style="text-align: center; margin: auto;">
          <ul style="text-transform: capitalize; font-size: 17px; font-family: 'Lobster', cursive; text-align: justify; max-height: 100vh;">
            <li>Coundtdown in popup</li><hr>
            <li>counter up service in the form of experience </li><hr>
            <li>Proper form validation</li><hr>
            <li>Restriction of dublicate data</li><hr>
            <li>Fully responsive in every device</li><hr>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="pop_Up">
      ...
      <button id="close_btn" class="btn btn-danger">Close</button>
         ...
         <form action="formdata.php" method="POST">
            <div class="form-group" style="max-width: 60%; margin-left: 20%;">
              <input type="text" class="form-control" name="user_name" placeholder="Enter Name" id="name" required autocomplete="off">
            </div>
            <div class="form-group"style="max-width: 60%; margin-left: 20%;">
              <input type="email" class="form-control" name="Email" placeholder="Enter email" id="email" required autocomplete="off">
            </div>
            <div class="form-group"style="max-width: 60%; margin-left: 20%;">
              <input type="text" class="form-control" name="mobile" placeholder="Enter Mobile" id="mobile" required autocomplete="off">
            </div>
            <div class="form-group"style="max-width: 60%; margin-left: 20%;">
              <textarea class="form-control" rows="3" name="text" id="comment" placeholder="Message.." required autocomplete="off"></textarea>
            </div>
...
<script>
    $(document).ready(function(){
      ...
      function showWindow(){
        $('.main_suggestion').show();
        // stop scrollpage
        // $('html body').css('overflow','hidden');

        // auto hide after 5 sec
        
      stopAatohide = setTimeout(hideWindow,31000);
      ...
      hideWindow();
      clearTimeout(stopAatohide);
    })

    })
  
</script>
<!-- suggestion popup ends here -->
  <!-- auto popup cde strats here -->
    <script>
    $(document).ready(function(){
      ...
      stopAutohide = setTimeout(hideWindow,70000);
