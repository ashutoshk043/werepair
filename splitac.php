...
<div class="container">
  <div class="row">
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-lg-6">
      <h1>WHAT IS A SPLIT TYPE AIR CONDITIONER, AND CAN IT REPLACE MY WINDOW UNITS?</h1>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-lg-6">
      <img src="images/splitac.jpg" alt="">
    </div>
  </div>
</div>
...
<div class="container">
  <h2 style="text-align: center; text-transform: capitalize; margin: 15px;font-weight: 700; font-family: 'Lobster', cursive;">Split ac</h2>
  <div class="row">
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
      <img src="images/splitac.jpg" alt="split_ac_image" class="img-fluid mt-5">
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
      <p>lorem500 Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur reprehenderit perferendis aut, numquam alias suscipit mollitia molestias, sed earum, voluptatibus aspernatur! Nulla totam, voluptas animi aliquam placeat? Ipsum itaque ducimus quo, aut facilis sit at blanditiis voluptatem ab accusantium architecto porro cumque soluta eos omnis provident incidunt. Quibusdam aliquam officia assumenda consectetur rem id praesentium quas tempore eos eveniet vitae, nam, possimus optio amet, necessitatibus enim aliquid neque, repudiandae nesciunt repellat consequuntur aut maxime. Similique molestias quisquam veritatis consequuntur aut dolorem tempore reiciendis culpa dolore harum commodi odio ipsum fugit consequatur voluptas, sunt quos sequi repellat enim sint nesciunt laborum.s</p>
    </div>
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
      <img src="images/splitac.jpg" alt="images" style="width:100%; max-height: 400px; padding: 15px;">
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
      <p>Lorem ipsum dolor sit, amet, consectetur adipisicing elit. Enim id libero natus illum fugiat, ratione ullam est odio, qui suscipit ab vel perferendis. Est quos ipsa veniam tempora fugit magni vero officiis commodi similique? Voluptatibus esse accusantium id dolores ipsam ut, laborum reprehenderit quos modi perferendis voluptatum consequatur sequi aliquam!</p>
    </div>
      <div class="upper_nav">
        <h4 class="text-center">Now contact us :</h4>
        <div class="row">
          <div class="col col-sm-12 col-md-12 col-lg-6 col-xl-6 text-right">
            <div class="row">
            <div class="col-2 col-sm-2 col-md-2 text-right ml-2">
